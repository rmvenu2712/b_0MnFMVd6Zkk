...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      quote: "The Aero-V3 has transformed our patient rotation protocols. The precision of the lateral tilt is unmatched.",
      name: "Dr. Sarah Jensen",
      title: "Head of Critical Care, Metro General",
    },
    {
      quote: "Reliability is everything. SKYON Innovations beds are the only ones that survived our 5-year rigorous stress test without a single failure.",
      name: "Marcus Thorne",
      title: "Director of Procurement, Global Health Group",
    },
    {
      quote: "The modularity of the OT systems allowed us to optimize our theater turnover times by 15%. Engineering excellence at its peak.",
      name: "Dr. Aris Thorne",
      title: "Chief of Surgery, St. Jude Medical",
    },
    {
      quote: "Their beds aren't just furniture; they're data-driven care platforms. The durability is unmatched in high-traffic environments.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 py-8">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button onClick={scrollNext} className="p-3 rounded-full border border-outline-variant/30 text-white hover:bg-surface-variant transition-colors hover:text-primary hover:border-primary">
                      ...
                      <div className="glass-card bg-surface-container/40 p-10 rounded-xl border border-outline-variant/10 space-y-6 h-full flex flex-col justify-between">
                        <div>
                          <div className="flex text-tertiary mb-6">
                            {[1, 2, 3, 4, 5].map((s) => (
                              <Star key={s} className="w-5 h-5 fill-tertiary text-tertiary" />
                            ))}
                          </div>
                        ...
                        <div className="pt-6 mt-6 border-t border-outline-variant/10">
                          ...
                          <p className="text-xs text-on-surface-variant mt-1">{t.title}</p>
                        </div>
                      </div>
                    </div>
                  ))}
