...
import { ArrowRight, CheckCircle2, ShieldCheck, Leaf, Users, Sparkles, BarChart3, BadgeCheck, Clock3, FileCheck2 } from "lucide-react";
  ...
  return (
    <div ref={ref} className="h-48 w-full flex items-end gap-1 overflow-hidden">
      {bars.map((h, i) => (
        <div
          key={i}
          className={`flex-1 rounded-t-sm bg-tertiary/80 origin-bottom transition-all duration-700 ease-out ${
        ...
        <section className="relative px-6 md:px-12 py-20 overflow-hidden">
          <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7 z-10">
              ...
              <h2 className="text-[36px] sm:text-3xl md:text-4xl md:text-8xl font-extrabold font-headline leading-tight tracking-tighter text-on-surface mb-8">
                The Future of <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-surface-container-high p-8 flex flex-col border border-outline-variant/10">
              ...
              <div className="mt-8 p-4 rounded-lg bg-surface-dim/50 border border-outline-variant/10">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="w-2 h-2 rounded-full bg-tertiary shadow-[0_0_8px_#50d190]" />
                </div>
            ...
            <div className="md:col-span-2 rounded-xl bg-surface-container-high p-8 grid md:grid-cols-2 gap-8 items-center border border-outline-variant/10">
              ...
              <div>
                ...
                <Link href="/products" className="text-primary font-bold text-xs uppercase tracking-tighter hover:underline underline-offset-4 transition-all">
                  View Products
                </Link>
              </div>
            </div>
