  ...
  return (
    <main className="pt-24 technical-grid min-h-screen pb-10">
      ...
      <FadeInSection direction="up">
        <section className="px-8 py-5 md:py-20 max-w-7xl mx-auto text-center md:text-left relative">
      ...
      <FadeInSection>
        <section className="px-8 py-24 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end  gap-6">
            <div>
              <h2 className="font-headline text-4xl font-bold text-on-background">Client Testimonials</h2>
              <p className="text-on-surface-variant font-light mt-2">Trusted by leading healthcare and pharma institutions.</p>
            </div>
        ...
        <section className="px-8 py-20 mb-8">
          <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-20 text-center glass-panel border border-primary/10">
              <h2 className="font-headline text-4xl font-bold text-on-background mb-6">Ready to build your cleanroom?</h2>
