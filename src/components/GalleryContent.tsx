            ...
            <div className="lg:col-span-2 group relative overflow-hidden rounded-xl bg-surface-container-low transition-premium gallery-item-hover">
              ...
              <div className="absolute bottom-4 left-4 right-4 p-6 glass-card rounded-lg transition-premium group-hover:translate-y-[-4px]">
                <div className="flex justify-between items-start">
                  ...
                  <span className="material-symbols-outlined text-primary-container text-2xl group-hover:rotate-45 transition-transform" data-icon="north_east">&#xe5ce;</span>
                </div>
                <p className="text-xs md:text-sm text-on-surface-variant font-body mt-3 leading-relaxed opacity-0 group-hover:opacity-100 transition-premium max-w-md">
